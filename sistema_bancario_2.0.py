...
def depositar(saldo, valor, extrato, /):
    if valor > 0:
            ...
            print("\n=== Deposito de", valor, "reais realizado com sucesso. ===")            
    else:
...
def sacar(*, saldo, valor, extrato, limite_saques , numero_saques, LIMITE_SAQUES_DIAROS):
    excedeu_saldo = valor > saldo
    excedeu_limite = valor > limite_saques
    excedeu_saques = numero_saques >= LIMITE_SAQUES_DIAROS
